...
str_split(string_1, pattern = ' ', n=2, simplify=T)   # Matrix
s <- str_split
typeof(s)
s
s[[1]][[1]]
...
gregexpr("man", vector_1)               # list 형태로 출력
...
people <- c("rorori", "emilla", "youna")
str_match(people, 'o(\\D)')   # \\D 는 non-digit character를 의미
